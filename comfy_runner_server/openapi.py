                ...
                "application/json": {
                    "schema": {
                        ...
                        "properties": {
                            ...
                            "volume_size_gb": {"type": "integer", "description": "Create a pod-local network volume (mounted at /workspace) of this size in GB. Independent of the container disk."},
                            "container_disk_gb": {"type": "integer", "description": "Size of the ephemeral container disk in GB (where installations and downloaded models live). Default: 50."},
